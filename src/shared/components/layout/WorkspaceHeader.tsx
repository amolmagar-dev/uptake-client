...
/** Slim toolbar header for full-bleed workspace pages (editors, previews, AI workspace). */
export const WorkspaceHeader: React.FC<WorkspaceHeaderProps> = ({ title, description, leading, actions, children, className = "" }) => (
